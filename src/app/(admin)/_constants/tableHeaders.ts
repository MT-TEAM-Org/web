...
const getTypeSpecificHeaders = (isList: boolean) => ({
  ...
  detailContent: {
    ...
    reportType: {
      ...
      sortKorean: [
        "신고 유형 상습비방, 음란, 정치, 홍보, 기타 순",
        "신고 유형 음란, 상습비방, 정치, 홍보, 기타 순",
        "신고 유형 정치, 음란, 상습비방, 홍보, 기타 순",
        "신고 유형 홍보, 정치, 음란, 상습비방, 기타 순",
        "신고 유형 기타, 홍보, 정치, 음란, 상습비방 순",
      ],
    },
    userStatus: {
      key: "userStatus",
...
export const getHeaders = (type: string, isList: boolean) => {
  ...
  if (type === "suggestions") {
    ...
    return [
      ...
      typeSpecificHeaders.content.writer,
