...
const FeedbackNoticeItem = () => {
  return (
    <Link href="/customer/info">
      <div className="w-full min-h-[66px] border-b p-3 flex gap-3 border-gray1 bg-bg0 items-center justify-start cursor-pointer">
        ...
        <Image
          ...
          width={56}
          height={42}
          className="w-[56px] h-[42px] rounded-[5px] p-4 flex gap-[10px] bg-gray1"
        />
