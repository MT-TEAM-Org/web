  ...
  return (
    <div
      className={cn(
        "hidden",
        "tablet:hidden",
        "mobile:flex mobile:items-center mobile:justify-between mobile:w-full mobile:h-[48px] mobile:border-b mobile:border-gray2 mobile:absolute mobile:top-0 mobile:left-0"
      )}
    >
