      ...
      >
        ...
        <div className="flex flex-col min-h-[58px] gap-[6px] flex-1 mobile:min-w-0">
          <div className="flex flex-col justify-between">
            <p className="w-[194px] h-[24px] text-[16px] font-[700] leading-[24px] text-gray9 tracking-[-0.02em] align-middle text-ellipsis overflow-hidden whitespace-nowrap mobile:w-full">
              {gameEventData?.title}
            </p>
            <p className="w-[194px] h-[20px] text-[14px] font-[500] leading-[20px] tracking-[0%] align-middle text-gray7 text-ellipsis overflow-hidden whitespace-nowrap mobile:w-full">
              {gameEventData?.description}
            </p>
          </div>
          <p className="w-[194px] h-[18px] text-[12px] font-[500] leading-[18px] text-gray5 tracking-[-0.02em] align-middle mobile:w-full">
