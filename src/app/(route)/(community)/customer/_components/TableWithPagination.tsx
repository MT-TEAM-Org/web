...
const TableWithPagination = () => {
  const rows = Array.from({ length: 10 }, (_, index) => ({
    number: 10 - index,
    content: '제목입니다 제목입니다 제목입니다 제목입니다 제목입니다 제목입니다 제목입니다',
    date: '2025.02.03',
  }));
        ...
        <tbody>
          {rows.map((row) => (
            <tr key={row.number} className="h-[48px]">
              <td className="border-b border-gray-300 py-2 px-4 text-center text-[#424242] text-[16px] leading-[28px] font-[400]">{row.number}</td>
              <td className="border-b border-gray-300 py-2 px-4 text-[#424242] text-[16px] leading-[28px] font-[400]">{row.content}</td>
              <td className="border-b border-gray-300 py-2 px-4 text-center text-[#424242] text-[16px] leading-[28px] font-[400]">{row.date}</td>
            </tr>
          ))}
        </tbody>
      </table>
