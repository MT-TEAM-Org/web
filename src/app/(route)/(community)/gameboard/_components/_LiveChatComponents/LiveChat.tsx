...
const LiveChat = () => {
  return (
    <div className="w-[360px] h-[600px] rounded-[10px] border p-4 flex flex-col gap-3 border-gray3">
      ...
      <div className="w-full max-w-[328px] h-full max-h-[494px] rounded-[5px] bg-gray1">
        ...
        <div className="w-full max-w-[328px] min-h-[52px] pt-3 bg-white">
          <div className="w-full max-w-[328px] min-h-[40px] flex gap-2">
            <div className="w-[40px] h-[40px] rounded-[5px] border py-4 flex gap-[10px] border-gray2 items-center justify-center">
              <Plus />
            </div>
            <input
              type="text"
